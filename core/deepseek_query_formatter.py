# from llama_cpp import Llama  # Temporarily commented out due to import issues

def format_query(user_input):
    # Fallback function - just return the input as-is
    # TODO: Re-enable llama_cpp functionality when package is properly installed
    return user_input
