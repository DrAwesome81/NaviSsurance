...
class ChiefOfStaffTab(QWidget):
    ...
    def _build_chat_panel(self):
        ...
        self.ask_input.setMinimumHeight(96)
        self.ask_input.setMaximumHeight(140)
        self.ask_input.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
